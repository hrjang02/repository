...
# var = 'ta'
var = 'ws'
csv_directory = '/home/smkim/materials/ASOS/data'
...
grid_WRF = xr.open_dataset(f'/data07/dDN/mcip/{domain}_{year}/GRIDCRO2D_{domain}_{year}.nc')
...
MET_WRF = xr.open_dataset(f'/data08/WRF-ML/processed_mcip/202110/{domain}/METCRO2D_{domain}_EHC.nc')
...
#%%
fname = f'{domain}_ML_WSPD_{start_date}_{end_date}.pkl'
print(f'FILENAME:{fname}')

#%%
data_reWRF.to_pickle(f'/home/smkim/0_code/validation/{fname}')
